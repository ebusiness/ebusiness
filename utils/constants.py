...
POS_ATTENDANCE_COL_ADVANCES_PAID_CLIENT = 17
POS_ATTENDANCE_COL_ADVANCES_PAID = 18
POS_ATTENDANCE_COL_TRAFFIC_COST = 19  # 通勤交通費
POS_ATTENDANCE_COL_ALLOWANCE = 24  # 手当
POS_ATTENDANCE_COL_EXPENSES = 28  # 経費(原価)
POS_ATTENDANCE_COL_EXPENSES_CONFERENCE = 33  # 会議費
POS_ATTENDANCE_COL_EXPENSES_ENTERTAINMENT = 34  # 交際費
POS_ATTENDANCE_COL_EXPENSES_TRAVEL = 35  # 旅費交通費
POS_ATTENDANCE_COL_EXPENSES_COMMUNICATION = 36  # 通信費
POS_ATTENDANCE_COL_EXPENSES_TAX_DUES = 37  # 租税公課
POS_ATTENDANCE_COL_EXPENSES_EXPENDABLES = 38  # 消耗品
